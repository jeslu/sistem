...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference("Mark.count") do
      post marks_url, params: { mark: { active: @mark.active, mark: @mark.mark, slug: @mark.slug } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { active: @mark.active, mark: @mark.mark, slug: @mark.slug } }
