...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference("Servicio.count") do
      post servicios_url, params: { servicio: { active: @servicio.active, costo_serv: @servicio.costo_serv, description: @servicio.description, name_serv: @servicio.name_serv } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { active: @servicio.active, costo_serv: @servicio.costo_serv, description: @servicio.description, name_serv: @servicio.name_serv } }
